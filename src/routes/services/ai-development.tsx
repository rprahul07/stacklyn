...
const data: ServiceData = {
  ...
  faqs: [
    ...
    { q: "What is the cost of building an AI application?", a: "AI application development at Stacklyn starts at $3,600 for basic AI integrations. Full AI-powered products range from $10,000–36,000 depending on complexity. Ongoing LLM API costs (OpenAI, Anthropic) are billed to your account at provider rates." },
